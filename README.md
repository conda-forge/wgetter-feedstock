...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/wgetter-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/wgetter-feedstock)
...
Once the `conda-forge` channel has been enabled, `wgetter` can be installed with:

```
conda install wgetter
```

It is possible to list all of the versions of `wgetter` available on your platform with:
